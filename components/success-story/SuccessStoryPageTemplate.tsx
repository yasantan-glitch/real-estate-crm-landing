    ...
    <div className="border-t border-line py-10 first:border-t-0 first:pt-0">
      <div className="flex flex-col gap-6 md:flex-row md:gap-10">
        <div className="shrink-0 md:w-56">
          ...
          <h3 className="mt-2 text-xl font-bold text-brand">{module.title}</h3>
        </div>
            ...
            <div className="mt-6 grid gap-4 [grid-template-columns:repeat(auto-fit,minmax(220px,1fr))]">
              {module.images.map((image) => (
                <div
                  ...
                  className="relative aspect-video overflow-hidden rounded-[14px] border border-line bg-white shadow-card"
                >
                  <Image src={image.src} alt={image.alt} fill sizes="(min-width: 768px) 33vw, 90vw" className="object-cover" />
                </div>
              ))}
            </div>
          )}
  ...
  return (
    <main>
      ...
      <section className="bg-white">
        <div className="section !pb-10">
          ...
          <figure className="mx-auto mt-12 max-w-4xl">
            <div className="relative aspect-[16/9] overflow-hidden rounded-2xl border border-line bg-surface shadow-card">
      ...
      <section className="border-y border-line bg-surface">
        <div className="section grid gap-8 sm:grid-cols-2">
          <div>
      ...
      <section className="bg-white">
        <div className="section">
          <h2 className="h2 text-center">Modül Modül</h2>
          <div className="mt-10">
            {modules.map((module) => (
      ...
      <section className="border-t border-line bg-brand">
        <div className="section text-center">
          <h2 className="h2 !text-white">{cta.title}</h2>
          <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-zinc-400">{cta.text}</p>
          <div className="mt-8">
