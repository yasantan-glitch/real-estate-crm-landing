  ...
  return (
    <html lang="tr" className={plusJakartaSans.variable}>
      ...
      <body>
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-[100] focus:rounded-md focus:bg-white focus:px-4 focus:py-2 focus:text-brand focus:shadow-card"
        >
          Ana içeriğe geç
        </a>
